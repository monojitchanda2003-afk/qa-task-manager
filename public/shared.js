...
<footer style="background:#0f172a;color:#cbd5e1;padding:64px 5% 0;">
  ...
  <div style="max-width:1200px;margin:0 auto;padding:20px 0 24px;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:10px;font-size:13px;color:#64748b;">
    ...
    <span style="display:flex;align-items:center;gap:12px;flex-wrap:wrap;">
      <span style="font-size:12px;color:#64748b;">Designed &amp; Developed by</span>
      <a href="https://github.com/monojitchanda2003-afk" target="_blank" style="font-size:20px;font-weight:900;color:#16a34a;text-decoration:none;letter-spacing:-0.3px;">Monojit Chanda</a>
    </span>
  </div>
</footer>`;
